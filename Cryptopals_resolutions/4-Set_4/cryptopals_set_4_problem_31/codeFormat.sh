...
# src files
clang-format -i ./src/HMAC_SHA1.cpp ./src/HMAC.cpp ./src/MessageExtractionFacility.cpp ./src/Server.cpp ./src/SHA.cpp ./src/SHA1.cpp ./src/cryptopals_4_problem_31.cpp
# test files
