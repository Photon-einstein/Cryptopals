 ...
 * performing the following test: SHA1(key server || msg) == mac
 *
...
TEST_F(ServerTest, validateMac_ValidMac_ShouldReturnTrue) {
  ...
  std::string macHexS{"b240077242795755b85fa52c89c9806e0d68c277"};
 ...
 * of the mac is incorrect: SHA1(key server || msg) == mac
 *
