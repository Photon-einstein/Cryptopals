...
g++ -Wextra -std=c++17 ./src/cryptopals_set_3_problem_25.cpp ./build/Server.o ./build/Attacker.o ./build/Function.o ./build/AesEcbMachine.o ./build/AesCtrMachine.o -o ./build/cryptopals_set_3_problem_25.exe -lcrypto
./build/cryptopals_set_3_problem_25.exe
