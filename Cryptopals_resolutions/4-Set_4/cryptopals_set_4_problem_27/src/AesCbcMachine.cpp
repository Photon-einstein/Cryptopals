...
AesCbcMachine::AesCbcMachine(const int blockSize, const std::shared_ptr<Pad>& pad) {
...
false otherwise */
std::string AesCbcMachine::encryption(std::vector<unsigned char> &plaintextBytesAsciiFullText,
    bool *b) {
  ...
  if (flag == false) {
    perror("AesEcbMachine log | There was a problem in the function 'PadPKCS_7::pad()'.");
    *b = false;
    return encryptedText;
  }
  encryptedText = AesCbcMachine::aesCbcEncryption(plaintextBytesAsciiFullText, &flag);
  *b = flag;
  return encryptedText;
}
/******************************************************************************/
...
false otherwise */
std::string AesCbcMachine::decryption(std::vector<unsigned char> &encryptedBytesAsciiFullText,
    bool *b) {
  ...
  bool flag;
  decryptedText = AesCbcMachine::aesCbcDecryption(encryptedBytesAsciiFullText, &flag);
  if (flag == false) {
    *b = false;
    return decryptedText;
  } else {
  ...
  if (flag == false) {
    perror("AesEcbMachine log | There was a problem in the function 'PadPKCS_7::unpad()'.");
    *b = false;
    return decryptedText;
  }
  Function::convertVectorBytesToString(decryptedTextV, decryptedText);
  if (debugFlagExtreme == true) {
    std::cout<<"AesEcbMachine log | Size ciphertext decrypted: "<<decryptedText.size()<<" bytes."<<std::endl;
  }
  return decryptedText;
}
/******************************************************************************/
...
std::string AesCbcMachine::aesCbcEncryption(const std::vector<unsigned char> &plainTextBytesAsciiFullText,
    bool *b) {
  std::string encryptedText="";
  if (b == nullptr) {
    return encryptedText;
  ...
  bool flag;
  unsigned int size, i, encryptedTextLen, size2=plainTextBytesAsciiFullText.size();
  ...
  if (flag == false) {
    perror("AesEcbMachine log | There was an error in the function 'padPKCS_7'.");
    *b = false;
    return encryptedText;
  }
  ...
  if (plainTextPointer == nullptr) {
    perror("AesEcbMachine log | There was a problem in the memory allocation of the 'plainTextPointer'.");
    *b = false;
    return encryptedText;
  }
  encryptedTextPointer = (unsigned char*) calloc(size+1, sizeof (unsigned char));
  if (encryptedTextPointer == nullptr) {
    perror("AesEcbMachine log | There was a problem in the memory allocation of the 'encryptedTextPointer'.");
    *b = false;
    return encryptedText;
  }
  ...
  encryptedTextLen = AesCbcMachine::aesCbcEncryptWorker(plainTextPointer, size2,
  _key, _iv, encryptedTextPointer);
  if (debugFlagExtreme == true) {
    std::cout<<"AesEcbMachine log | Full Encrypted ECB text size = "<<encryptedTextLen<<" bytes."<<std::endl;
...
in the end it returns the decrypted text and sets flag b by reference to true if
no errors or to false otherwise */
std::string AesCbcMachine::aesCbcDecryption(const std::vector<unsigned char> &encryptedBytesAsciiFullText,
    bool *b) {
  std::string decryptedText;
  ...
  if (cypherTextPointer == nullptr) {
    perror("AesEcbMachine log | There was a problem in the memory allocation of the 'cyperTextPointer'.");
    *b = false;
    return decryptedText;
  }
  cypherTextDecryptedPointer = (unsigned char*) calloc(size+1, sizeof (unsigned char));
  if (cypherTextDecryptedPointer == nullptr) {
    perror("AesEcbMachine log | There was a problem in the memory allocation of the 'cypherTextDecryptedPointer'.");
    *b = false;
    return decryptedText;
  }
  ...
  decryptedTextLen = AesCbcMachine::aesCbcDecryptWorker(cypherTextPointer, size,
  _key, _iv, cypherTextDecryptedPointer);
  if (debugFlagExtreme == true) {
...
/******************************************************************************/
int AesCbcMachine::aesCbcEncryptWorker(unsigned char *plaintext, int plaintextLen, unsigned char *key,
...
/******************************************************************************/
int AesCbcMachine::aesCbcDecryptWorker(unsigned char *cyphertext, int cypherTextLen, unsigned char *key,
...
void AesCbcMachine::setBlockSize(int blockSize) {
  if (blockSize < 1) {
    throw std::invalid_argument("AesCbcMachine log | Bad blockSize: blockSize cannot be less than 1");
  }
  _blockSize = blockSize;
}
/******************************************************************************/
void AesCbcMachine::setPad(const std::shared_ptr<Pad>& pad) {
  _pad = pad;
}
/******************************************************************************/
void AesCbcMachine::setKey(const int blockSize) {
  ...
  if (_key == nullptr) {
    throw std::invalid_argument("AesCbcMachine log | There was a problem in the memory allocation of _key.");
  };
...
void AesCbcMachine::setIV(const int blockSize) {
  ...
  if (_iv == nullptr) {
    throw std::invalid_argument("AesCbcMachine log | There was a problem in the memory allocation of _iv.");
  };
  int i;
...
/******************************************************************************/
/* getters */
int AesCbcMachine::getBlockSize() {
  return _blockSize;
}
/******************************************************************************/
unsigned char* AesCbcMachine::getKey() {
  return _key;
}
/******************************************************************************/
unsigned char* AesCbcMachine::getIV() {
  return _iv;
}
/******************************************************************************/
