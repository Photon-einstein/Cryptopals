...
g++ -Wextra -std=c++17 ./src/cryptopals_set_4_problem_27.cpp ./build/Server.o ./build/Attacker.o ./build/Function.o ./build/AesCbcMachine.o ./build/Pad.o ./build/padPKCS_7.o -o ./build/cryptopals_set_4_problem_28.exe -lcrypto
./build/cryptopals_set_4_problem_28.exe
