...
g++ -Wall -std=c++17 ./src/cryptopals_set_2_problem_16.cpp  ./build/Function.o ./build/Pad.o ./build/PadPKCS_7.o ./build/Server.o ./build/Attacker.o -o ./build/cryptopals_set_2_problem_16.exe -lcrypto
