...
int main (void) {
  ...
  flag = Function::guessSizeRandomPrefix(randomPrefixWork, sizeRandomPrefixGuess);
  if (flag == false) {
    ...
    printf("The function 'guessSizeRandomPrefix' correctly estimated the size of the random prefix used in AES ecb mode as %d bytes.", sizeRandomPrefixGuess);
  } else {
    printf("The function 'guessSizeRandomPrefix' failed estimated the size of the random prefix used in AES ecb mode as %d bytes.", sizeRandomPrefixGuess);
  }*/
  /* end of the work */
  end = clock();
