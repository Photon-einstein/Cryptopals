...
# test files
clang-format -i ./tests/test_SHA256.cpp ./tests/test_SHA384.cpp ./tests/test_SHA512.cpp ./tests/test_SecureRemotePasswordProtocol.cpp ./tests/test_SessionData.cpp ./tests/test_srpParametersLoader.cpp
