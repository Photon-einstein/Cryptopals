...
# test files
clang-format -i ./tests/test_Client.cpp ./tests/test_SHA1.cpp ./tests/test_SHA256.cpp ./tests/test_SHA384.cpp ./tests/test_SHA512.cpp ./tests/test_SecureRemotePasswordProtocol.cpp ./tests/test_Server.cpp ./tests/test_SessionData.cpp ./tests/test_srpParametersLoader.cpp
