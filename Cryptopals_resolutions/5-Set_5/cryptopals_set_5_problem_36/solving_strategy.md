...
67. Create unit tests for each group ID (Done)
    67.1. Group ID 1 (Done)
    67.2. Group ID 2 (Done)
    67.3. Group ID 3 (Done)
    67.4. Group ID 4 (Done)
    67.5. Group ID 5 (Done)
...
85. Add unit tests to test S against the results obtained at the script (Done)
    85.1 Add test with valid parameters (Done)
