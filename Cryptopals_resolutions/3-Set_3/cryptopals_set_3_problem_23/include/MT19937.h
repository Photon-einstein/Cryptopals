...
public:
    ...
    void seedMt(const std::vector<unsigned int> &stateVector);
    ...
    bool checkEqualVectorState(const std::vector<std::uint32_t> &_mt19937StateVector);
